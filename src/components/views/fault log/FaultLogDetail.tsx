...
import { ChevronDown, ChevronUp, Link, Shield, FileText, Pencil, Printer, ExternalLink, FileCheck, Trash2 } from "lucide-react";
...
const FaultLogDetail: React.FC<FaultLogDetailProps> = ({ onBack }) => {
  ...
  const tabs = [
    ...
    { id: "Shield", label: null, icon: <Shield size={18} /> },
  ];
